...
// uppercase, and titlecase.
                            //toLowerCase
// let myName: string = "Rizwan"; 
// console.log(myName.toLocaleLowerCase());
//                             //toUpperCase
// console.log(myName.toUpperCase());
//                             //toTitleCase
// let sentence: string = "Rizwan";                            
// console.log(sentence.replace(/\bw/g,c =>  c.toUpperCase()));
...
// Question.8.You should creat four lines that look like this (5+3) in console.
// console.log(4+4);
// console.log(16-8);
// console.log(2*4);
// console.log(24/3);
...
// let numbers: string[]= ['Subhan','salamn','hadi','rizwan','ali'];
...
// let names: string[]= ['shan','shahid','sohail','Rizwan','hadi'];
